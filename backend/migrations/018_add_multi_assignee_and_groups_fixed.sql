-- Migration 018: Add Multi-Assignee Support AND Team Groups (FIXED)
...
-- Create teams/groups table - FIXED: workspace_id should be UUID not INTEGER
...
-- Create sample teams for testing (using real workspace IDs)
...
-- Add sample team memberships (using placeholder user IDs for now)
INSERT INTO workspace_team_members (team_id, user_id, role, joined_by) VALUES
-- Kitchen Team
((SELECT id FROM workspace_teams WHERE name = 'kitchen-team' LIMIT 1), 'chef1', 'lead', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'kitchen-team' LIMIT 1), 'cook1', 'member', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'kitchen-team' LIMIT 1), 'cook2', 'member', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'kitchen-team' LIMIT 1), 'server1', 'member', 'system'),

-- Frontend Dev Team
((SELECT id FROM workspace_teams WHERE name = 'frontend-dev' LIMIT 1), 'dev1', 'lead', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'frontend-dev' LIMIT 1), 'dev2', 'member', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'frontend-dev' LIMIT 1), 'dev3', 'member', 'system'),

-- Backend Dev Team  
((SELECT id FROM workspace_teams WHERE name = 'backend-dev' LIMIT 1), 'dev4', 'lead', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'backend-dev' LIMIT 1), 'dev5', 'member', 'system'),

-- Design Team
((SELECT id FROM workspace_teams WHERE name = 'design-team' LIMIT 1), 'designer1', 'lead', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'design-team' LIMIT 1), 'designer2', 'member', 'system'),

-- Marketing Team
((SELECT id FROM workspace_teams WHERE name = 'marketing' LIMIT 1), 'marketer1', 'lead', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'marketing' LIMIT 1), 'marketer2', 'member', 'system'),
((SELECT id FROM workspace_teams WHERE name = 'marketing' LIMIT 1), 'marketer3', 'member', 'system');
