...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Future<void> _loadMessages({bool loadMore = false}) async {
    ...
    try {
      ...
      print('📝 Using demo messages for development');
      
      // Fallback to demo messages for development
      setState(() {
  ...
  List<Message> _getDemoMessages() {
    ...
    return [
      ...
      Message(
        id: 'msg_4',
        content: 'Perfect! I\'ll start working on the design mockups today.',
        messageType: 'text',
      ...
      Message(
        id: 'msg_3',
        content: 'Great progress team! The new features are looking fantastic. 🚀',
        messageType: 'text',
      ...
      Message(
        id: 'msg_2',
        content: 'I just pushed the updates to the repository. Ready for review!',
        messageType: 'text',
        senderId: currentUserId,
        senderName: user?.displayName ?? 'You',
        senderAvatar: user?.photoURL,
      ...
      Message(
        id: 'msg_1',
        content: 'Hey team! Welcome to ${widget.thread.name}. Let\'s get started! 👋',
        messageType: 'text',
        senderId: 'other_user_1',
        senderName: 'Jane Smith',
        senderAvatar: null,
  ...
  Future<void> _sendMessage(String content) async {
    ...
    try {
      ...
      // The actual message will come via socket stream
      // Remove temp message after delay (it will be replaced by real one)
